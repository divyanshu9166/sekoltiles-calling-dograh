...
- CONSENT GATE after YOU offer transfer: call it only if the latest reply explicitly says “हाँ/हां/जी हाँ/yes/कर दो/connect कर दो”. “नहीं/no/मत/रहने दो” = end_call. Any unclear or mistranscribed reply (including “main” or silence) is NOT consent: ask one yes/no clarification.`
